...
<div class="container-fluid">
	<div class="row">
	  ...
	  <a href="delcart.php?productid=0" style="text-decoration: none; color: white"><button type = "button" class="btn btn-danger">Delete All</button></a>
	     ...
	     <div class="container" style="border-top: 3px solid #38D276">
              ...
              <form method="POST" action="thanhtoan.php" class="was-validated">
                ...
                <div class="form-group">
                	<div class="form-group">
                		...
                		<input type="text" class="form-control" id="usr" name="data" value="<?php date_default_timezone_set('Asia/Ho_Chi_Minh'); echo "".date("Y.m.d h:i:sa"); ?>" readonly >
                	</div>
